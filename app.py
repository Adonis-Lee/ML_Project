    ...
    try:
        ...
        if st.sidebar.button("🚀 Train Model"):
            ...
            if model_name == "Perceptron":
                ...
                # Hoca MLP istediği için iterasyonu artırdım hata vermesin diye
            ...
            with tab3:
                ...
                # Eğer Decision Tree ise Ağacı Çiz (Bonus Özellik!)
        ...
        st.warning("İpucu: CSV dosyanızın formatını kontrol edin.")

else:
    st.info("Lütfen sol panelden bir CSV dosyası yükleyin.")
